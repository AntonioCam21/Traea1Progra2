    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                {
                    Console.WriteLine("1- Apriete el boton S para Sumar");
                    Console.WriteLine("2- Apriete el boton A para Restar");
                    Console.WriteLine("3- Apriete el boton D para Dividir");
                    Console.WriteLine("4- Apriete el boton F para Multiplicar");
                    Console.WriteLine("Desea continuar digite S para Continuar o N para salir..(s/n)");
                    Opcion = char.Parse(Console.ReadLine());
